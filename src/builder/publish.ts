...
// renderToStaticMarkup, generates theme-derived CSS, and bundles both
...
/** Full style.css for the exported page: font imports + token vars + base reset. */
...
function buildIndexHTML(bodyHTML: string, title: string): string {
...
/** Render the page to a .zip containing index.html + style.css and trigger download. */
export async function publishToZip(
  ...
  const indexHTML = buildIndexHTML(bodyHTML, title);
